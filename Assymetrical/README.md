...
Микросхемы аналоговых умножителей утратили былую популярность. Тем не менее, простой аналоговый умножитель можно собрать на ячейке Гилберта. Точность не требуется, четырехквадрантное умножение тоже ни к чему, поэтому схему можно предельно упростить:
