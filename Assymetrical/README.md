...
[Квадратичную передаточную функцию](https://github.com/akouz/MusEff/blob/main/Mult/README.MD) легко получить если умножить сигнал сам на себя. Однако микросхемы аналоговых умножителей дОроги. Простой аналоговый умножитель можно собрать на ячейке Гилберта. Точность не требуется, четырехквадрантное умножение тоже ни к чему, поэтому схему можно предельно упростить:
...
Умножитель можно также сделать на основе транскондукторного усилителя. Эта идея была воплощена Р.Мугом в линейке полностью полупроводниковых усилителей Lab Series в конце 70-х. Использование [умножителя](https://aionfx.com/app/files/schematics/Lab_Series_L5_L7_L9_L11_schematic.pdf)  на основе CA3080/CA3280/CA3094 позволяло получать [звучание](https://www.youtube.com/watch?v=JzR54nKKtJQ), не уступающее ламповым усилителям. Впоследствии фирма Aion выпустила [примочку](https://aionfx.com/project/l5-preamp/), аналогичнную [предусилителю](https://www.youtube.com/watch?v=dp7VQmfxpdc) Lab Series L5. В качестве умножителя использован LM13700.

## 4. Дифкаскад

Дифкаскад дает еще одну возможность получить передаточную фунцию похожую на квадратичную. Для этого достаточно в режиме покоя подать на один из транзисторов постоянное смещение, как это показано еа Fig.15. Получившаяся передаточная функция и ее первая производная при R3=33к, а также спектр при искажениях на выходе 10%,  показаны там же.
...
Легко видеть, что получившийся спектр больше напоминает "диодный" спектр Fig.2,  чем спектр квадратичной функции или спектр JFET Fig.12.

На Fig.16 показаны формы выходного сигнала и соответствующие спектры.
...
Еще одна возможность построить нелинейную передаточную фунцию состоит в том, чтобы использовать усилительный каскад с общим эмиттером без отрицательных обратных связей по переменному току. Это было реализовано в середине 60-х в устройстве Dallas Rangemaster: 
