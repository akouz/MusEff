...
Дифкаскад дает еще одну возможность получить передаточную фунцию похожую на квадратичную. Для этого достаточно в режиме покоя подать на один из транзисторов постоянное смещение, как это показано еа Fig.15. Получившаяся передаточная функция и ее первая производная при R3=33к показанs там же.
