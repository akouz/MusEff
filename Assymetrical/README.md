...
Квадратичную передаточную функцию легко получить если умножить сигнал сам на себя. Однако микросхемы аналоговых умножителей дОроги, а транскондакторные усилители имеют нелинейную передаточную характеристику по управляющему входу. Простой аналоговый умножитель можно собрать на ячейке Гилберта. Точность не требуется, четырехквадрантное умножение тоже ни к чему, поэтому схему можно предельно упростить:
