...
Из этого следует, что если кремниевые диоды в клиппере сдвинуть влево, подав на них небольшое положительное смещение, то передаточные характеристики станут такиме же как у германиевых клипперов и звучат они будут одинаково. Нужное напряжение смещения можно получить, если через опорный диод пропустить небольшой ток, а получившееся на нем падение напряжения буферизовать и использовать как напряжение смещения для клиппера. Для диодов 1N4148 получившиеся передаточные характеристики при токах смещения опорного диода 10 мкА и 20 мкА таковы:
...
Артефакты в начале графика производной вызваны неидеальностью использованного дифференциатора, при помощи которого вычислялась производная. 
...
Квадратичными функциями описываются передаточные характеристики триодных ламповых каскадов. Создаваемые ими искажения имеют быстро затухающий спектр. 
